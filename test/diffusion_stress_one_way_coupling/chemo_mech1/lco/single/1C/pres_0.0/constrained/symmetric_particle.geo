...
//+
Symmetry {3.5, 0, 0, 0} {
  Duplicata { Curve{12}; Curve{11}; Curve{14}; Curve{7}; Curve{13}; Curve{6}; Curve{4}; Curve{3}; Curve{2}; Curve{1}; Surface{1}; Surface{2}; Surface{3}; Curve{8}; Curve{9}; Curve{5}; Curve{10}; Surface{4}; Surface{5}; }
}
