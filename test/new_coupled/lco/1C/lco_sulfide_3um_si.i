...
[Functions]
  [./flux_t]
    type = ParsedFunction
    vars = 'current faraday'
    vals = '15.0 96485.33289'  # A/m^2 Fardaays constant
    # value = 'if (t <= 3600, -1.0*current/faraday, current/farday)'
    value = '-current/faraday'
  [../]
[]
[AuxVariables]
  [./flux]
...
[Materials]
  [./heat_inner]
    ...
    diffusion_coefficient = 5e-11 # D = 10^-13 m^2/s/ R = 8.314/T=298 K
    gas_constant = 8.314
    temperature = 298
    block = 'inner'
  [../]
  ...
  [./density_inner]
    ...
    prop_names = 'density'
    prop_values = '4.9e3' #silicon in mol/(um^3)
    block = 'inner'
  [../]
  [./density_outer]
    type = GenericConstantMaterial
    prop_names = 'density'
    prop_values = '5e3' #silicon in mol/(m^3)
    block = 'outer'
  [../]
