...
registerMooseObject("electro_chemo_mechApp", Bower2012);


template <>
InputParameters
validParams<Bower2012>()
{
...
Bower2012::Bower2012(const InputParameters& parameters)
...
void
Bower2012::computeJacobian()
{
    Kernel::computeJacobian();
}

void
Bower2012::computeOffDiagJacobian(MooseVariableFEBase & jvar)
{
    Kernel::computeOffDiagJacobian(jvar);
}

Real
Bower2012::computeQpJacobian()
{
...
Real
Bower2012::computeQpOffDiagJacobian(unsigned int jvar)
{
